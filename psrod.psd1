...
# M�dulos que devem ser importados para o ambiente global antes da importa��o deste m�dulo
# RequiredModules = @()
...
# M�dulos para importa��o como m�dulos aninhados do m�dulo especificado em RootModule/ModuleToProcess
...
FunctionsToExport = @("Add-MySqlColumn", "clone", "Confirm-Choice", "Connect-MySqlServer", "ConvertFrom-B64", "ConvertFrom-PS2MD", "ConvertFrom-Timestamp", "ConvertTo-B64", "ConvertTo-FlatObject", "ConvertTo-MarkdownTable", "ConvertTo-MorseCode", "ConvertTo-TextToWav", "Disconnect-MySqlServer", "Discord", "Find-OpenPorts", "Get-GoogleAnswer", "Get-MySqlColumn", "Get-MySqlDatabase", "Get-MySqlTable", "Get-MySqlUser", "Get-RandomSecret", "Get-Repositories", "Get-ScheduledTasks", "Get-SocketMessage", "Get-UserSession", "GetRequiredManifestKeyParams", "Import-Repositories", "Invoke-ClearDisk", "Invoke-MySqlQuery", "Invoke-Test", "New-Appointment", "New-DynamicParam", "New-MySqlDatabase", "New-MySqlTable", "New-MySqlUser", "New-QrCode", "Notify", "Pause", "PromptChoice", "Read-NetworkSpeed", "Select-MySqlDatabase", "Send-SocketMessage", "Show-BalloonTip", "Show-Calendar", "Show-Notification", "ShowMenu", "Timer", "Update-Repos", "Wait-Action", "Write-Calendar")
...
# Lista de todos os m�dulos empacotados com este m�dulo
# ModuleList = @()
